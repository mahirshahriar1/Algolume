...
import {
  ArrowLeft, ArrowRight, BarChart3, BookOpen, Check, Clock, Compass, GitBranch,
  Hash, Layers, ListTree, MonitorPlay, Network, Play, Repeat, RotateCcw, Rows3,
  Search, Sigma, Spline, Terminal, type LucideIcon,
} from "lucide-react";
...
const ICONS: Record<string, LucideIcon> = {
  Compass, Rows3, Search, BarChart3, Repeat, Spline, Layers, Hash, GitBranch, ListTree, Network, Terminal,
};
